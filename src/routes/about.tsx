      ...
      <div className="grid md:grid-cols-2 gap-12 mt-12 items-start">
        ...
        <div className="space-y-5 text-muted-foreground leading-relaxed">
          ...
          <p>
            ...
            pigments, and finished by a small team in Porto. We make in small runs so nothing
            is wasted, and we&apos;d rather a piece live with you for a decade than a season.
          </p>
          <p>
